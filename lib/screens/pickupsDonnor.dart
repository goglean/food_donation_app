...
class upcomingdonations extends StatefulWidget {
  ...
  upcomingdonations({required this.callback});
  @override
...
class _upcomingdonationsState extends State<upcomingdonations> {
  ...
  void upcomlist() async {
    await FirebaseFirestore.instance
        .collection("pickup_details")
        .get()
        .then((querySnapshot) {
      querySnapshot.docs.forEach((result) {
        if (result['email'] == FirebaseAuth.instance.currentUser?.email &&
                    ...
                    child: Column(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                                startdateslist[index] +
                                    " " +
                                    starttimeslist[index] +
                                    " - " +
                                    enddateslist[index] +
                                    " " +
                                    endtimeslist[index],
                            ...
                            SizedBox(height: 24),
                            Text("Our pick-up details for the volunteer",
                                style: GoogleFonts.roboto(
                                    decoration: TextDecoration.underline,
                                    fontSize: 15,
      ...
      return Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Text(
                "There are no added donations to be picked up.",
