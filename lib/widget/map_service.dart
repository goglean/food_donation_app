    ...
    for (var i = 0; i < data.length; i++) {
      ...
      if (data[i]['email'] == email) {
        return Restaurent2(
          ...
          endTime: data[i]['endtime'][11] +data[i]['endtime'][12] +data[i]['endtime'][13] + data[i]['endtime'][14] +data[i]['endtime'][15]  ?? '',
          startDate: data[i]['startdate'] ?? '',
          startTime: data[i]['starttime'][11] + data[i]['starttime'][12] + data[i]['starttime'][13] + data[i]['starttime'][14]+ data[i]['starttime'][15]?? '',
  ...
  List<Restaurent2> _pickupRestaurentListFromSnapshot(QuerySnapshot snapshot) {
    return snapshot.docs.map((doc) {
      ...
      return Restaurent2(
        ...
        email: doc['email'] ?? '',
        endDate: doc['enddate'] ?? '',
        endTime: doc['endtime'][11] +doc['endtime'][12] +doc['endtime'][13] + doc['endtime'][14] +doc['endtime'][15]  ?? '',
        startDate: doc['startdate'] ?? '',
        startTime: doc['starttime'][11]+ doc['starttime'][12]+ doc['starttime'][13]+ doc['starttime'][14]+ doc['starttime'][15] ?? '',
